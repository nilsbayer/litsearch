                    ...
                    if (data.message === "OK") {
                        ...
                        data.new_results.slice(0,4).forEach(new_result => {
                            ...
                            <div class="icon-container">
                                ...
                                <span class="summary-cta" data-tooltip="Read the summary">
                                    <svg style="pointer-events: none;" width="16" height="30" viewBox="0 0 20 28" fill="none" xmlns="http://www.w3.org/2000/svg">
